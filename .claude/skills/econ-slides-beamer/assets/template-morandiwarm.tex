...
\begin{frame}{Authors}
\begin{itemize}
\item \textbf{Zhongshu Qian} - Economist, Clayton University. | Macroeconomics and industrial organization.
\item \textbf{Yao Lu} - Economist, Marsh Academy. | Development economics and digital economy.
\end{itemize}
\end{frame}
